...
class LabelMakerPro:
    ...
    def migrate_single_task(self, task_path, task_classes):
        """Converts any folder containing obj_train_data* into standard images/ and labels/ format."""
        ...
        legacy_folders = [d for d in task_path.glob("obj_train_data*") if d.is_dir()]
        migrated = False
        ...
        if legacy_folders:
            for folder in legacy_folders:
                ...
                # Clean up now-empty legacy directory
                shutil.rmtree(folder, ignore_errors=True)

        # Ensure data.yaml exists in the task root
    ...
    def update_stats(self, *args):
        ...
        for iid in selected_iids:
            ...
            if img_dir.exists():
                ...
                # Fallback check for legacy paths if unmigrated
                for folder in task_path.glob("obj_train_data*"):
    ...
    def load_previews(self):
        """Loads images strictly from the standardized images/ folder."""
        ...
        if images_dir.exists():
            ...
            for folder in self.training_session_path.glob("obj_train_data*"):
